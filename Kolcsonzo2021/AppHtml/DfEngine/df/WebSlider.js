...
slide : function(eType, bRanged, oEvent){
    ...
    */
    function onStopSlide(oEvent){
        ...
        if(eType === 0){
            df.dom.off("mouseup", window, onStopSlide);
            df.dom.off("mouseup", eMask, onStopSlide);
            df.dom.off("mousemove", eMask, onDragSlide);
        }else if(eType === 1){
            df.dom.off("pointerup", window, onStopSlide);
            df.dom.off("pointerup", eMask, onStopSlide);
            df.dom.off("pointermove", window, onDragSlide);
        }else if(eType === 2){
            df.dom.off("touchend", window, onStopSlide);
            df.dom.off("touchend", eMask, onStopSlide);
            df.dom.off("touchmove", window, onDragSlide);
        }
