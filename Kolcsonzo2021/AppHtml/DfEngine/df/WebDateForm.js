...
initPicker : function(){
    ...
    oPnl.psCSSClass = "NoWitespace Shadow WebDateForm_FlPnl";
    oPnl.OnHide.addListener(this.onPanelClose, this);
    oPnl.create();
    
    oPicker = this._oPicker = new df.WebDatePicker(null, this);
    ...
    //oPicker._eBuddy = this._eControl;
    
    oPicker.psCSSClass = "WebDatePicker_Form NoWitespace";
