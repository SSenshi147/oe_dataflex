...
'
    ...
    Set oWebResourceManager = Server.CreateObject("WebAppServer.WebBusinessProcess.19.1")
    ...
    If (oFSO.FileExists(sFilePath)) Then
        ...
        sContentType = oWebResourceManager.call("Get_ContentType", oFSO.GetExtensionName(sFileName))
