...
rowHtml : function(tRow, aHtml, bZebra){
    ...
    aHtml.push(oL._sHtmlTemplate.replace(this.rRegEx, function(sMatch, sP1){
        ...
        if(oCol){
            return that.cellHtml(oCol, tRow.aCells[oCol._iColIndex]);
        }
        return sMatch;
    }));
}
...
*/
df.WebHtmlListView = function(oList, oModel, oController){
    df.WebHtmlListView.base.constructor.call(this, oList, oModel, oController);
};
df.defineClass("df.WebHtmlListView", "df.WebListView", {
...
tableHtml : function(aHtml){
    ...
    df.WebHtmlListView.base.tableHtml.call(this, aHtml);
...
createView : function(){
    return new df.WebHtmlListView(this, this._oModel, this._oController);
},
