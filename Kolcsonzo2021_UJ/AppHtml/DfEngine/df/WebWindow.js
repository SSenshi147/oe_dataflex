...
afterRender : function(){
    ...
    if(this.pbFloating){
        ...
        //  Buttons
        df.dom.on("mousedown", this._eCloseBtn, function(oEvent){ oEvent.stop(); });
...
onStartDrag : function(oEvent){
    ...
    function onStopDrag(oEvent){
        df.dom.off("mouseup", eMask, onStopDrag);
        df.dom.off("mouseup", window, onStopDrag);
        //df.dom.off("mouseout", eMask, onStopDrag);
        df.dom.off("mousemove", eMask, onDrag);
