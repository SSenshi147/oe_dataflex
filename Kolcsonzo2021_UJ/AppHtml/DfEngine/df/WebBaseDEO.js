...
genWinMask : function(sMask){
    ...
    */
    ...
    return {
        ...
        detach : function(){
            if(that._eControl){
                df.dom.off("keydown", that._eControl, filterWinMask);
                df.dom.off("input", that._eControl, correctWinMask);
            }
        }
    }
},
...
genDateMask : function(eDataType){
    ...
    return {
        detach : function(){
            if(that._eControl){
                df.dom.off("keydown", that._eControl, filterDate);
                df.dom.off("input", that._eControl, correctDate);
                df.dom.off("focus", that._eControl, updateFormat);
            }
        }
    }
},
...
genNumMask : function(){
    ...
    return {
        detach : function(){
            if(that._eControl){
                df.dom.off("keydown", that._eControl, filterNumeric);
                df.dom.off("input", that._eControl, correctNumeric);
                df.dom.off("focus", that._eControl, updateFormat);
            }
        }
    }
